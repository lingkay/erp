...
use Gist\AccountingBundle\Entity\GeneralJournalEntry;
use DateTime;
use SplFileObject;
use LimitIterator;

class GeneralJournalController extends CrudController
{
    use TrackCreate;
    ...
    {
        $this->route_prefix = 'gist_accounting_general';
        $this->title = 'General Journal';
        $this->list_title = 'General Journal';
        $this->list_type = 'dynamic';
        $this->repo = "GistAccountingBundle:GeneralJournalEntry";
    }


    protected function newBaseClass()
    {
        return new GeneralJournalEntry();
    }
    ...
    public function addSubmitAction()
    {
        ...
        {
            $this->update($data);
            $this->addFlash('success','General Journal Entries added successfully.');
    ...
    protected function update($data)
    {
        ...
        foreach ($data['account'] as $key => $account_id) {
            $cdj_entry = new GeneralJournalEntry();
