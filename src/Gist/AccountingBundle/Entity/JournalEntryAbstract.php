 ...
 * @ORM\Table(name="acctg_journal_entry")
 * @ORM\InheritanceType("SINGLE_TABLE")
 * @ORM\DiscriminatorColumn(name="journal_type", type="string")
 * @ORM\DiscriminatorMap({"cdj_entries" = "\Gist\AccountingBundle\Entity\CDJJournalEntry",
 *						"crj_entries" = "\Gist\AccountingBundle\Entity\CRJJournalEntry",
 *						"gj_entries" = "\Gist\AccountingBundle\Entity\GeneralJournalEntry",
 *                         })
 */

abstract class JournalEntryAbstract
{
