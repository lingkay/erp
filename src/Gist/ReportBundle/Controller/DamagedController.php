...
class DamagedController extends CrudController{
    ...
    {
        $this->route_prefix = 'gist_report_damaged';
    ...
    public function indexAction() {
        $this->title = 'Damaged Report';
        $params = $this->getViewParams('', 'gist_report_damaged_summary');
        $inv = $this->get('gist_inventory');
        
        $this->print = 'gist_report_damaged_print';
        $this->csv = 'gist_report_damaged_csv';
        ...
        return $this->render('GistReportBundle:Damaged:index.html.twig', $params);
    }
...
//        $params['data'] = $data;
        ...
        return $this->render(
            'GistReportBundle:Damaged:print.html.twig', $params);
    }
