...
class DrController extends CrudController{
    ...
    public function indexAction() {
        $this->title = 'Delivery Receipt Report';
        $params = $this->getViewParams('', 'gist_report_dr_summary');
        $inv = $this->get('gist_inventory');
        
        $this->print = 'gist_report_dr_print';
        $this->csv = 'gist_report_dr_csv';
        ...
        return $this->render('GistReportBundle:Dr:index.html.twig', $params);
    }
...
//        $params['data'] = $data;
        ...
        return $this->render(
            'GistReportBundle:Dr:print.html.twig', $params);
    }
