...
class EquipmentReportController extends BaseController
{
    public function indexAction($date_from = null , $date_to = null)
    {
        ...
        $this->print = 'gist_report_equipment_print';
        $this->csv = 'gist_report_equipment_csv';
        $this->filter = 'gist_report_equipment_summary_filter';
    ...
    protected function fetchData($date_from, $date_to)
    {
        ...
        $equip_id = $this->get('gist_configuration')->get('gist_product_group_equipment_default');
