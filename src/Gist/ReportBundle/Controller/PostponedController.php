...
class PostponedController extends BaseController
{
    public function indexAction($date_from = null , $date_to = null)
    {
        ...
        $this->print = 'gist_report_postponed_print';
        $this->csv = 'gist_report_postponed_csv';
        $this->filter = 'gist_report_postponed_summary_filter';

        // get params
        $params = $this->getViewParams('', 'gist_report_postponed_summary');
