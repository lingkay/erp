...
class GenerateWeeklyController extends BaseController
{
    public function __construct()
    {
        $this->route_prefix = 'hris_payroll_weekly_generate';
        $this->title = 'Weekly Payroll';

        $this->list_title = 'Weekly Payroll';
    ...
    public function indexAction()
    {
        ...
        $wsched = json_decode($conf->get('hris_payroll_weekly_sched'), true);

        $params = $this->getViewParams('', 'hris_payroll_generate_index');
        $this->padFormParams($params);
        $params['wsched'] = $wsched;
        $params['payroll'] = [];
        ...
        $twig_file = 'HrisPayrollBundle:GenerateWeekly:index.html.twig';
    ...
    public function filterAction()
    {
        ...
        // }elseif($sched->getName() == PayPeriod::TYPE_WEEKLY){
            $date_from = $data['wdate_from'];
            $date_to = $data['wdate_to'];
        // }
        ...
        $params = $this->getViewParams('', 'hris_payroll_weekly_generate_index');
    ...
    protected function notify($date_from, $date_to, $period)
    {
        ...
        $msg = sprintf("Weekly Payroll Generated for %s employees for period %s to %s. ", 
                $period->getName(),
        ...
        $event->notify(array(
            'source'=> 'Weekly Payroll Generated',
    ...
    public function detailsAction($id)
    {
        ...
        $twig_file = 'HrisPayrollBundle:GenerateWeekly:details.html.twig';
