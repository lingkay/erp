...
trait HasContactPersons
{
    protected function updateHasContactPersons($o, $data, $is_new)
    {
        ...
        if(isset($data['person_id']))
        {
            ...
            {
                $contact_person = $em->getRepository('CatalystContactBundle:ContactPerson')->find($data['person_id'][$index_id]);
        ...
        if(isset($data['phone_id']))
        {
            ...
            {
                $contact_person = $em->getRepository('CatalystContactBundle:ContactPerson')->find($data['contact_person_id'][$index_id]);
                $phone = $em->getRepository('CatalystContactBundle:Phone')->find($data['phone_id'][$index_id]);
