...
class NotificationManager
{
    ...
    {
        $users = $this->em->getRepository("CatalystUserBundle:User")->findByEnabled(true);
            ...
            $message = $this->mailer->createMessage()
                ...
                ->setBody(
                    $this->templating->render(
                        'CatalystNotificationBundle:Notification:notification_email.html.twig',
    ...
    {
        return $this->em->getRepository('CatalystNotificationBundle:NotificationQueue')
            ->findBy(array('user'=>$user),array('id' => 'DESC'),$limit);
    }

    public function findNotification($id)
    {
        return $this->em->getRepository('CatalystNotificationBundle:NotificationQueue')->find($id);
    }
}