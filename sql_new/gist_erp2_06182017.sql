...
INSERT INTO `acct_bank_account` VALUES (2,NULL,'Generic Bank X Account','Credit Card','2017-06-11 09:21:58','09839870307','Salcedo Makati Branch','PHP','','Active',1);
...
CREATE TABLE `acct_bank_charge` (
  ...
  CONSTRAINT `FK_F2463BE111C8FB41` FOREIGN KEY (`bank_id`) REFERENCES `acct_bank` (`id`),
...
INSERT INTO `acct_terminal` VALUES (1,2,NULL,'BDO','1','1','Rental','565765457','sdf','89789789','2343465735',NULL,NULL,'Active','sdf','2017-06-11 11:42:53',1,1,1);
...
-- Dump completed on 2017-06-18 12:55:56
