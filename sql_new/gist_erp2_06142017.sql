...
CREATE TABLE `acct_bank` (
  ...
  `list_id` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `acct_bank` VALUES (1,NULL,'BDO','1','Active','2017-06-14 05:34:06');
...
CREATE TABLE `acct_terminal` (
  ...
  `user_create_id` int(11) DEFAULT NULL,
  `actual_location` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `registered_location` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `acct_terminal` VALUES (1,2,NULL,'X','X','BDO','1','1','Rental','565765457','sdf','89789789','2343465735',NULL,NULL,'Active','sdf','2017-06-11 11:42:53',1);
...
-- Dump completed on 2017-06-14 14:54:35
