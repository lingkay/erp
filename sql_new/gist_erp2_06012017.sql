...
CREATE TABLE `user_user` (
  ...
  CONSTRAINT `FK_F7129A80BD0F409C` FOREIGN KEY (`area_id`) REFERENCES `user_areas` (`id`),
...
-- Dump completed on 2017-06-01  9:58:42
